...
RegisterNetEvent('t1ger_pawnshop:ShowAdvancedNotifyESX')
AddEventHandler('t1ger_pawnshop:ShowAdvancedNotifyESX', function(title, subject, msg, icon, iconType)
...
RegisterNetEvent('t1ger_pawnshop:ShowNotifyESX')
AddEventHandler('t1ger_pawnshop:ShowNotifyESX', function(msg)
	ShowNotifyESX(msg)
end)
