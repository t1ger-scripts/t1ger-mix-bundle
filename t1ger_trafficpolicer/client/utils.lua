...
RegisterNetEvent('t1ger_trafficpolicer:notifyAdvanced')
AddEventHandler('t1ger_trafficpolicer:notifyAdvanced', function(title, subject, msg, icon, iconType)
...
RegisterNetEvent('t1ger_trafficpolicer:notify')
AddEventHandler('t1ger_trafficpolicer:notify', function(msg)
	ShowNotifyESX(msg)
end)
